...
namespace EasyNetQ.Custom.Serializer
{
    public class CustomSerializer : ISerializer
    {
        ...
        public CustomSerializer() : this(DefaultSerializerSettings)
        {
        }

        public CustomSerializer(Newtonsoft.Json.JsonSerializerSettings serializerSettings)
        {
